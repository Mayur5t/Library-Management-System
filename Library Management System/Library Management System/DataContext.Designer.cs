...
// Code is generated on: 2/9/2022 4:01:18 PM
//
...
namespace LibraryManagementContext
{
    ...
    public partial class BookDetail : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="BookDetail_BookReturn", Storage="_BookReturns", ThisKey="BookId", OtherKey="BookId", DeleteRule="NO ACTION")]
    ...
    /// <summary>
    /// There are no comments for LibraryManagementContext.BookReturn in the schema.
    /// </summary>
    ...
    public partial class BookReturn : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// There are no comments for ReturnDate in the schema.
        /// </summary>
        [Column(Name = @"Return_Date", Storage = "_ReturnDate", DbType = "DATETIME", UpdateCheck = UpdateCheck.Never)]
        public System.DateTime? ReturnDate
        {
            get
            {
        ...
        /// There are no comments for BookDetail in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="BookDetail_BookReturn", Storage="_BookDetail", ThisKey="BookId", OtherKey="BookId", IsForeignKey=true)]
        public BookDetail BookDetail
        {
            get
            {
